...
- Ветка "v2" на GitHub является работоспособной, имеет статус "active" и не требует модификации исходных кодов. Не смотря на экспериментальный характер сборки, именно её следует использовать для промышленного кода
